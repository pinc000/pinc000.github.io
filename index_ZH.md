...
请注意，为了访问Pinc000 API，您必须拥有一个已充值的资金账户。

#### 数据格式

Pinc000 API仅支持JSON格式。
...
Pinc000 API支持HTTP压缩。我们强烈建议使用压缩，这将提供最佳性能。
...
# API状态
您可以关注 [Pinc000 状态页面](https://status.pinc000.com/)并订阅以获取有关 API 状态的通知。


**[Pinc000的开放API规](https://github.com/pinc000/pinc000.github.io/tree/main/docs/OpenAPI)**范托管在GitHub上。
