...
Обратите внимание, что в следующей версии /fixtures свойство rotNum будет отменено.
...
Используйте Get Settled Fixtures, чтобы узнать, был ли период события завершён или событие было удалено.
 ...
 ### Почему мне запрещён доступ к Esports?

 Доступ к Esports заблокирован для всех аккаунтов. Чтобы получить доступ, пожалуйста, свяжитесь с обслуживанием клиентов и объясните ваш бизнес-кей
